...
## Project Structure
    ...
    ├── on_demand_care_temp_38046  # Django project configurations
...
1. Clone this repo and `cd on_demand_care_temp_38046`
...
2. Clone this repo and `cd on_demand_care_temp_38046`
